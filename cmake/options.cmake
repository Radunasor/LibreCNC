...
###GCODE OCOMMANDS SUPPORT OPTION###
option(${PROJECT_NAME_UPPER}_GCODE_OCOMMAND_SUPPORT "GCODE OCOMMANDS Support" OFF)
if(${PROJECT_NAME_UPPER}_GCODE_OCOMMAND_SUPPORT)
    set(LC_SUPPORT_O_COMMANDS 1)
else()
    set(LC_SUPPORT_O_COMMANDS 0)
endif()